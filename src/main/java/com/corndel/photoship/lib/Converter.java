...
public class Converter {
    ...
    public void saveImage() throws IOException {
        String prefix = this.filename.split("\\.")[0];
        ImageIO.write(this.image, "jpg", new File("src/main/resources/img/" + prefix + "-output.jpg"));
        printSuccessMessage(prefix);
    }

    public void printSuccessMessage(String prefix) {
        System.out.println("Great! Output is saved in src/main/resources/img/" + prefix + "-output.jpg");
    }
