...
public class Pixels {
    ...
    public static List<Integer> invert(List<Integer> rgb) {
        ...
        List<Integer> invertRgb = rgb.stream().map(rgbValue -> 255 - rgbValue).toList();
        return invertRgb;
    }
    ...
    public static List<Integer> grayscale(List<Integer> rgb) {
        ...
        int average = rgb.stream().mapToInt(Integer::intValue).sum() / 3;
        // Set all components to the average value to create a grayscale effect
        return List.of(average, average, average);
    }
    ...
    public static List<Integer> blackAndWhite(List<Integer> rgb) {
        ...
        // to 255 (white)
        return grayscale(rgb).stream().map(rgbValue -> rgbValue >= 128 ? 255 : 0).toList();
    }
